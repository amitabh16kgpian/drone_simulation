...
# Initial conditions
ini = np.random.randint(1, 10 + 1, size=(num_d, 4))
...
# for i in range(len(drone_state1)):
#     drone_state1[i][0] = initial_position[i]


# drone_state2 = [initial_position + initial_velocity]*num_d
# for i in range(len(drone_state2)):
#     drone_state2[i][0] = initial_position[i]
drone_state1=ini
drone_state2=ini
print(ini)
# Simulation loop
...
for t in np.arange(0, simulation_time, dt):
    ...
    for d in range(num_d):
        ...
        drone_state1[d]=uavdynamics(list(drone_state1[d])+mcoord)
    ...
    for d in range(num_d):
        ...
        drone_state2[d]=uavdynamics(list(drone_state2[d])+mcoord)
        # drone_state = uavdynamics(drone_state + [target_waypoint[0], target_waypoint[1]])
        # Update display
